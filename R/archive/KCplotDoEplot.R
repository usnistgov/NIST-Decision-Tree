                   ...
                   ylab=NULL, ylim=NULL, exclude=NULL)
{
    ...
    ## title.line = Line relative to the plot (positive away from the
    ##    upper side of the plotting area, negative into the plotting area)
